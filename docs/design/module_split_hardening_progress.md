...
| H2B | Root slimming | Exec/session root logic | `refactor/hardening-root-exec-service` | `/data/src/github.com/kingfs/agent-compose-hardening-root-exec-service` | pending | `assigned` | pending | Keep runtime/session behavior compatible; use minimal safe slice. |
| H2C | Root slimming | Compatibility facade audit | `refactor/hardening-root-compat` | `/data/src/github.com/kingfs/agent-compose-hardening-root-compat` | pending | pending | `assigned` | Remove only proven-redundant wrappers. |
...
| 3 | `refactor/hardening-root-exec-service` | `assigned` | Minimal exec/session root slimming slice. |
| 4 | `refactor/hardening-root-compat` | `assigned` | Compatibility facade audit after H2A. |
...
| `/data/src/github.com/kingfs/agent-compose-hardening-root-exec-service` | `refactor/hardening-root-exec-service` | pending | `assigned` | Yes |
| `/data/src/github.com/kingfs/agent-compose-hardening-root-compat` | `refactor/hardening-root-compat` | pending | `assigned` | Yes |

...
- 全局 env 存储：`internal/persistence/sqlite/config_store.go`
- session 创建和 env 合并：`internal/app/session_rpc_bridge.go`、`internal/loader/manager.go`、`internal/app/run_preparation.go`
...
- LLM service：`pkg/llm/client.go`、`internal/app/service.go`
- Runtime LLM Facade：`internal/persistence/sqlite/llm_config.go`、`internal/app/llm_facade.go`、`internal/app/llm_facade.go`

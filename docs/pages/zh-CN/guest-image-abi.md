...
官方镜像是一个覆盖面较广的开发环境。Baseline ABI 不要求特定 Linux 发行版、`apt`、Go、C/C++ compiler、`grpcurl`、protobuf compiler、Git、curl、`tini`、所有 provider CLI、Jupyter、额外 kernel 或离线 runtime SDK。

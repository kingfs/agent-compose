...
func (s *Store) UpsertProject(ctx context.Context, project ProjectRecord) (ProjectRecord, error) {
...
func (s *Store) SaveProjectRevision(ctx context.Context, revision ProjectRevisionRecord) (ProjectRevisionRecord, bool, error) {
...
func (s *Store) GetProjectIncludingRemoved(ctx context.Context, projectID string) (ProjectRecord, bool, error) {
	return s.getProject(ctx, projectID, true)
}

func (s *Store) ListProjects(ctx context.Context, options ProjectListOptions) (ProjectListResult, error) {
	limit := options.Limit
	if limit <= 0 {
		limit = 50
	}
...
func (s *Store) GetProjectRevision(ctx context.Context, projectID string, revision int64) (ProjectRevisionRecord, error) {
...
func (s *Store) UpsertProjectAgent(ctx context.Context, agent ProjectAgentRecord) (ProjectAgentRecord, error) {
...
func (s *Store) GetProjectAgent(ctx context.Context, projectID, agentName string) (ProjectAgentRecord, error) {
...
func (s *Store) ListProjectAgents(ctx context.Context, projectID string) ([]ProjectAgentRecord, error) {
...
func (s *Store) UpsertProjectScheduler(ctx context.Context, scheduler ProjectSchedulerRecord) (ProjectSchedulerRecord, error) {
...
func (s *Store) GetProjectScheduler(ctx context.Context, projectID, schedulerID string) (ProjectSchedulerRecord, error) {
...
func (s *Store) SetProjectSchedulerEnabled(ctx context.Context, projectID, schedulerID string, enabled bool) (ProjectSchedulerRecord, error) {
	projectID = strings.TrimSpace(projectID)
...
func (s *Store) ListProjectSchedulers(ctx context.Context, projectID string) ([]ProjectSchedulerRecord, error) {
...
func (s *Store) CreateProjectRun(ctx context.Context, run ProjectRunRecord) (ProjectRunRecord, error) {
...
func (s *Store) UpdateProjectRun(ctx context.Context, run ProjectRunRecord) (ProjectRunRecord, error) {
	run, err := normalizeProjectRunRecord(run)
	if err != nil {
		return ProjectRunRecord{}, err
	}
...
func (s *Store) GetProjectRun(ctx context.Context, runID string) (ProjectRunRecord, error) {
...
func (s *Store) ListProjectRuns(ctx context.Context, projectID string, limit int) ([]ProjectRunRecord, error) {
	return s.ListProjectRunsByOptions(ctx, ProjectRunListOptions{ProjectID: projectID, Limit: limit})
}

func (s *Store) ListProjectRunsByOptions(ctx context.Context, options ProjectRunListOptions) ([]ProjectRunRecord, error) {
	limit := options.Limit
	if limit <= 0 {
		limit = 50
	}
	...
	if source := strings.TrimSpace(options.Source); source != "" {
		...
		args = append(args, domain.NormalizeProjectRunSource(source))
	}
...
func (s *Store) getProject(ctx context.Context, projectID string, includeRemoved bool) (ProjectRecord, bool, error) {
	projectID = strings.TrimSpace(projectID)
	if projectID == "" {

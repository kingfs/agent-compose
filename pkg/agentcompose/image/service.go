...
func NewService(dockerImages, ociImages, autoImages ImageBackend) *Service {
	return &Service{
		images:     dockerImages,
		ociImages:  ociImages,
...
func NewDockerImageBackendWithClient(newClient func() (DockerImageClient, error), now func() time.Time) *DockerImageBackend {
	return &DockerImageBackend{
		newClient: newClient,
		now:       now,
	}

...
type Manager interface {
	...
	CreateLoader(ctx context.Context, loader Loader) (Loader, error)
	UpdateLoader(ctx context.Context, loader Loader) (Loader, error)
	DeleteLoader(ctx context.Context, loaderID string) error
	SetLoaderEnabled(ctx context.Context, loaderID string, enabled bool) (Loader, error)
	SetLoaderTriggerEnabled(ctx context.Context, loaderID, triggerID string, enabled bool) (Loader, error)
	RunNow(ctx context.Context, loaderID, triggerID, payloadJSON string, timeout time.Duration) (LoaderRunSummary, error)
}

type Repository interface {
	ListLoaderSummaries(ctx context.Context) ([]LoaderSummary, error)
	GetLoader(ctx context.Context, loaderID string) (Loader, error)
	ListLoaderRuns(ctx context.Context, loaderID string, limit int) ([]LoaderRunSummary, error)
	GetLoaderRun(ctx context.Context, loaderID, runID string) (LoaderRunSummary, error)
	ListLoaderEvents(ctx context.Context, loaderID string, limit int) ([]LoaderEvent, error)
}

type DefaultAgentResolver func(ctx context.Context, agentID, provider string) (string, error)

type Service struct {
	Manager             Manager
	Repository          Repository
	ResolveDefaultAgent DefaultAgentResolver
}
...
func (s *Service) ListLoaders(ctx context.Context, req *connect.Request[emptypb.Empty]) (*connect.Response[agentcomposev1.ListLoadersResponse], error) {
	_ = req
	items, err := s.Repository.ListLoaderSummaries(ctx)
	if err != nil {
...
func (s *Service) GetLoader(ctx context.Context, req *connect.Request[agentcomposev1.LoaderIDRequest]) (*connect.Response[agentcomposev1.LoaderResponse], error) {
	item, err := s.Repository.GetLoader(ctx, req.Msg.GetLoaderId())
	if err != nil {
...
func (s *Service) CreateLoader(ctx context.Context, req *connect.Request[agentcomposev1.CreateLoaderRequest]) (*connect.Response[agentcomposev1.LoaderResponse], error) {
	...
	item, err := s.Manager.CreateLoader(ctx, Loader{
...
func (s *Service) UpdateLoader(ctx context.Context, req *connect.Request[agentcomposev1.UpdateLoaderRequest]) (*connect.Response[agentcomposev1.LoaderResponse], error) {
	...
	item, err := s.Manager.UpdateLoader(ctx, Loader{
		Summary: LoaderSummary{
...
func ParseRunTimeout(raw string) (time.Duration, error) {
	return parseLoaderRunTimeout(raw)
}
...
func (s *Service) ListLoaderRuns(ctx context.Context, req *connect.Request[agentcomposev1.ListLoaderRunsRequest]) (*connect.Response[agentcomposev1.ListLoaderRunsResponse], error) {
	runs, err := s.Repository.ListLoaderRuns(ctx, req.Msg.GetLoaderId(), int(req.Msg.GetLimit()))
	if err != nil {
		return nil, connect.NewError(connect.CodeInternal, err)
	}
...
func (s *Service) GetLoaderRun(ctx context.Context, req *connect.Request[agentcomposev1.LoaderRunIDRequest]) (*connect.Response[agentcomposev1.LoaderRunResponse], error) {
	run, err := s.Repository.GetLoaderRun(ctx, req.Msg.GetLoaderId(), req.Msg.GetRunId())
	if err != nil {
		return nil, connect.NewError(connect.CodeNotFound, err)
	}
	return connect.NewResponse(&agentcomposev1.LoaderRunResponse{Run: toProtoLoaderRunDetail(run)}), nil
...
func (s *Service) ListLoaderEvents(ctx context.Context, req *connect.Request[agentcomposev1.ListLoaderEventsRequest]) (*connect.Response[agentcomposev1.ListLoaderEventsResponse], error) {
	events, err := s.Repository.ListLoaderEvents(ctx, req.Msg.GetLoaderId(), int(req.Msg.GetLimit()))
	if err != nil {
		return nil, connect.NewError(connect.CodeInternal, err)
	}

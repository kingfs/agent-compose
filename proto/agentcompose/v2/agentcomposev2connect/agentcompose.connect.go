...
const (
	...
	// ResourceServiceResolveResourceProcedure is the fully-qualified name of the ResourceService's
	// ResolveResource RPC.
	ResourceServiceResolveResourceProcedure = "/agentcompose.v2.ResourceService/ResolveResource"
)
...
type ResourceServiceClient interface {
	ResolveResource(context.Context, *connect.Request[v2.ResolveResourceRequest]) (*connect.Response[v2.ResolveResourceResponse], error)
}
...
func NewResourceServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) ResourceServiceClient {
	...
	return &resourceServiceClient{
		resolveResource: connect.NewClient[v2.ResolveResourceRequest, v2.ResolveResourceResponse](
			httpClient,
			baseURL+ResourceServiceResolveResourceProcedure,
			connect.WithSchema(resourceServiceMethods.ByName("ResolveResource")),
			connect.WithClientOptions(opts...),
		),
	}
}
...
type resourceServiceClient struct {
	resolveResource *connect.Client[v2.ResolveResourceRequest, v2.ResolveResourceResponse]
}

// ResolveResource calls agentcompose.v2.ResourceService.ResolveResource.
func (c *resourceServiceClient) ResolveResource(ctx context.Context, req *connect.Request[v2.ResolveResourceRequest]) (*connect.Response[v2.ResolveResourceResponse], error) {
...
func NewResourceServiceHandler(svc ResourceServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	resourceServiceMethods := v2.File_agentcompose_v2_agentcompose_proto.Services().ByName("ResourceService").Methods()
	resourceServiceResolveResourceHandler := connect.NewUnaryHandler(
		ResourceServiceResolveResourceProcedure,
		svc.ResolveResource,
		connect.WithSchema(resourceServiceMethods.ByName("ResolveResource")),
		connect.WithHandlerOptions(opts...),
	)
	return "/agentcompose.v2.ResourceService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
		case ResourceServiceResolveResourceProcedure:
			resourceServiceResolveResourceHandler.ServeHTTP(w, r)
		default:
			http.NotFound(w, r)
		}
	})
...
func (UnimplementedResourceServiceHandler) ResolveResource(context.Context, *connect.Request[v2.ResolveResourceRequest]) (*connect.Response[v2.ResolveResourceResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("agentcompose.v2.ResourceService.ResolveResource is not implemented"))
}
